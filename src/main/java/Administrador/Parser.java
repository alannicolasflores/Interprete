...
public class Parser {
    ...
    void DECLARATION() { // rev
        ...
        if (preanalisis.equals(Class)) {// se analiza el primero
            ...
            VAR_DECL();
            DECLARATION();
        } else if (preanalisis.equals(llave1) || preanalisis.equals(While) || preanalisis.equals(Return)
                || preanalisis.equals(print) || preanalisis.equals(If) || preanalisis.equals(For)
                || preanalisis.equals(neg) || preanalisis.equals(menos) || preanalisis.equals(True)
    ...
    void CLASS_DECL() {
        ...
        if (preanalisis.equals(Class)) {
            ...
            hayErrores = true;
            System.out
                    .println("Error en la línea " + preanalisis.linea + ". Se esperaba la palabra reservada Class.");
        }
    }
    ...
    void FUN_DECL() {
        ...
        if (preanalisis.equals(fun)) {
            ...
            hayErrores = true;
            System.out.println("Error en la línea " + preanalisis.linea + ". Se esperaba la palabra reservada fun.");
        }
    }
    ...
    void VAR_DECL() {
        ...
        if (preanalisis.equals(var)) {
            ...
            hayErrores = true;
            System.out.println("Error en la línea " + preanalisis.linea
                    + ". Se esperaba la palabra reservada var identificador o ;");
        }
    }
    ...
    void STATEMENT() {// rev
        ...
        if (preanalisis.equals(neg) || preanalisis.equals(menos) || preanalisis.equals(True)
            ...
            hayErrores = true;
            System.out.println("Error en la línea " + preanalisis.linea
                    + ". Se esperaba la palabra reservada ! - true false null this numero cadena identificador super ( for if print return while ).");
        }
    }
    ...
    void EXPR_STMT() { // rev
        ...
        if (preanalisis.equals(neg) || preanalisis.equals(menos) || preanalisis.equals(True)
            ...
            hayErrores = true;
            System.out.println("Error en la línea " + preanalisis.linea
                    + ". Se esperaba la palabra reservada ! - true false null this numero cadena identificador super ( .");
        }
    }
    ...
    void FOR_STMT() {// rev
        ...
        if (preanalisis.equals(For)) {
            ...
            hayErrores = true;
            System.out.println("Error en la línea " + preanalisis.linea + ". Se esperaba la palabra reservada for.");
        }
    }
    ...
    void FOR_STMT_1() {// rev
        ...
        if (preanalisis.equals(var)) {
            VAR_DECL();
        } else if (preanalisis.equals(neg) || preanalisis.equals(menos) || preanalisis.equals(True)
                || preanalisis.equals(False) || preanalisis.equals(Null) || preanalisis.equals(This)
                || preanalisis.equals(numero) || preanalisis.equals(cadena) || preanalisis.equals(identificador)
            ...
            hayErrores = true;
            System.out.println("Error en la línea " + preanalisis.linea
                    + ". Se esperaba la palabra reservada var ! - true false null this numero cadena identificador super ( ;.");
        }
    }
    ...
    void IF_STMT() {// rev
        ...
        if (preanalisis.equals(If)) {
            ...
            hayErrores = true;
            System.out.println("Error en la línea " + preanalisis.linea + ". Se esperaba la palabra reservada if.");
        }
    ...
    void PRINT_STMT() {// rev
        ...
        if (preanalisis.equals(print)) {
            ...
            hayErrores = true;
            System.out
                    .println("Error en la línea " + preanalisis.linea + ". Se esperaba la palabra reservada print.");
        }
    }
    ...
    void RETURN_STMT() {// rev
        ...
        if (preanalisis.equals(Return)) {
            ...
            hayErrores = true;
            System.out.println(
                    "Error en la línea " + preanalisis.linea + ". Se esperaba la palabra reservada return.");
        }
    }
    ...
    void WHILE_STMT() {// rev
        ...
        if (preanalisis.equals(While)) {
            ...
            hayErrores = true;
            System.out
                    .println("Error en la línea " + preanalisis.linea + ". Se esperaba la palabra reservada While.");
        }
    }
    ...
    void BLOCK() {// rev
        ...
        if (preanalisis.equals(llave1)) {
            ...
            hayErrores = true;
            System.out.println(
                    "Error en la línea " + preanalisis.linea + ". Se esperaba la palabra reservada LLAVE1.");
        }
    }
    ...
    void BLOCK_DECL() {// rev
        ...
        if (preanalisis.equals(neg) || preanalisis.equals(menos) || preanalisis.equals(True)
                || preanalisis.equals(False) || preanalisis.equals(Null) || preanalisis.equals(This)
                || preanalisis.equals(numero) || preanalisis.equals(cadena) || preanalisis.equals(identificador)
                || preanalisis.equals(Super) || preanalisis.equals(par1) || preanalisis.equals(For)
                || preanalisis.equals(If) || preanalisis.equals(print) || preanalisis.equals(Return)
                || preanalisis.equals(While) || preanalisis.equals(llave1) || preanalisis.equals(Class)
                || preanalisis.equals(fun) || preanalisis.equals(var)) {
            DECLARATION();
            BLOCK_DECL();
        }
    }
    ...
    void UNARY() {// rev
        ...
        if (preanalisis.equals(neg)) {
            ...
            UNARY();
            FACTOR_2();
        } else if (preanalisis.equals(True) || preanalisis.equals(False) || preanalisis.equals(Null)
                || preanalisis.equals(This) || preanalisis.equals(numero) || preanalisis.equals(cadena)
                || preanalisis.equals(identificador) || preanalisis.equals(Super) || preanalisis.equals(par1)) {
            CALL();
        } else {
            hayErrores = true;
            System.out.println("Error en la línea " + preanalisis.linea
    ...
    void CALL() {
        if (hayErrores)
            return;
        if (preanalisis.equals(True) || preanalisis.equals(False) || preanalisis.equals(Null)
                || preanalisis.equals(This) || preanalisis.equals(numero) || preanalisis.equals(cadena)
                || preanalisis.equals(identificador) || preanalisis.equals(Super) || preanalisis.equals(par1)) {
            PRIMARY();
            CALL_2();
    ...
    void ARGUMENTS() {// rev
        ...
        if (preanalisis.equals(neg) || preanalisis.equals(menos) || preanalisis.equals(True)
            ...
            hayErrores = true;
            System.out.println(
                    "Error en la línea " + preanalisis.linea + ". Se esperaba la palabra reservada SELECT.");
        }
    }
    ...
    void coincidir(Token t) {
        ...
        if (preanalisis.tipo == t.tipo) {
            ...
            hayErrores = true;
            System.out.println("Error en la línea " + preanalisis.linea + ". Se esperaba un  " + t.tipo);
